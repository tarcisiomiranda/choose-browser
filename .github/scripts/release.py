#!/usr/bin/env python3
"""Validate artifacts and publish a choose-browser GitHub release."""
...
EXPECTED_BINARIES = {
    "choose-browser-linux-amd64",
    "choose-browser-linux-arm64",
}
...
class GitHubAPI:
    ...
    def _headers(self, content_type: str = "application/json") -> dict[str, str]:
        return {
            ...
            "User-Agent": "choose-browser-release-script",
...
def collect_and_verify_assets(release_dir: Path) -> list[Path]:
    ...
    binary_paths = {path.name: path for path in release_dir.glob("choose-browser-*")}
